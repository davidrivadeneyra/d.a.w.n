      ...
      <main className="main main-background">
        ...
        <section className="main-inner-section pb-32">
          <div className="lg:w-[530px] ">
            <h1 className="title-h1 title-color pb-3 lg:pb-8 pt-44">
              <span className="title-h2 block ">Survive the</span> Darkness
            </h1>
            <p className="paragraph-primary paragraph-color pb-8">
              D.A.W.N: Darkness Awaits Withstand the Night is a fast-paced
            ...
            <div className="wishlist-info flex lg:flex gap-2 ">
              <a
                target="_black"
                href="https://store.steampowered.com/agecheck/app/1938500/"
              ...
              >
                ...
                />
                <span className="button-font text-xs lg:text-sm  text-[#EDF67D]">
                  WISHLIST ON STEAM
                </span>
              </a>
              <span className="paragraph-secondary text-xs lg:text-sm">
                Available: Apr 1, 2025
              </span>
            </div>
          </div>
        </section>
      ...
      <div className="main-background">
        <div className="w-full section-gradiente-top">
          <section className="main-inner-section pb-40">
            <h1 className="title-h2 title-color pt-24 pb-20 text-center uppercase">
              D.A.W.N Roadmap
            </h1>
            <h3 className="title-h4 paragraph-orange-500 pb-2">Stage 1:</h3>

            <h2 className="title-h3 title-color pb-8 md:pb-16">
            ...
            <div className="path-section flex flex-col-reverse md:grid md:grid-cols-12 gap-8 md:gap-16">
              <div className="path-list flex flex-col gap-10 col-span-3">
                <div className="path-item">
                  <span className="uppercase paragraph-orange-500 paragraph-medium pb-2">
                    Patch 1.0
                  </span>
                  <h3 className="title-h4 title-color pb-4">First Blood</h3>
                  <span className="paragraph-medium title-color block">
                    Release Date: October 11, 2024
                  </span>
                  <p className="paragraph-primary paragraph-color ">
                    Initial release, core zombie AI (Wretches), and basic player
                    movement/combat.
                  </p>
                </div>
                <div className="path-item">
                ...
                <div className="path-item">
                  ...
                  <p className="paragraph-primary paragraph-color ">
                    Zombie variants (fast and tough Wretches) and ranged weapons
                    for players.
                  </p>
                </div>
                <div className="path-item">
                  ...
                  <h3 className="title-h4 title-color pb-4">
                    Defensive Measures
                  </h3>
                  <span className="paragraph-medium title-color block">
                  ...
                  <p className="paragraph-primary paragraph-color ">
                    Player traps, simple crafting, and early progression
                    mechanics.
                  </p>
                </div>
              </div>
              <div className="path-image col-span-9 relative visible">
                <img
                  ...
                  className="aspect-ratio-img absolute blur-2xl top-0 w-full z-0"
                  alt=""
                />
                <img
                  src="/assets/img/02.jpg"
                  className="aspect-ratio-img relative rounded-3xl"
                  alt=""
                />
              </div>
            </div>
              ...
              <div className="path-section flex flex-col-reverse md:grid md:grid-cols-12 gap-8 md:gap-16">
                <div className="path-list flex flex-col gap-10 col-span-3">
                  <div className="path-item">
                    ...
                    <p className="paragraph-primary paragraph-color ">
                      Hunters evolve from Wretches, introducing kill-based
                      progression.
                    </p>
                  </div>
                  <div className="path-item">
                    ...
                    <p className="paragraph-primary paragraph-color ">
                      Enhanced tracking for Hunters, player stats, and
                      leaderboards.
                    </p>
                  </div>
                  <div className="path-item">
                    ...
                    <p className="paragraph-primary paragraph-color ">
                      Advanced ranged combat for players, with improved tactical
                      AI for Hunters.
                    </p>
                  </div>
                  <div className="path-item">
                    ...
                    <p className="paragraph-primary paragraph-color ">
                      Event system implementation, with real-time notifications
                      for key zombie/player actions.
                    </p>
                  </div>
                </div>
                <div className="path-image col-span-9 relative visible">
        ...
        <div className="py-40 section-image">
          <section className="main-inner-section pt-40">
            <div className="">
              <div className="lg:w-[530px] ">
                <h1 className="title-h2 title-color pb-3 lg:pb-8 pt-24">
              ...
              <div className="path-section flex flex-col-reverse md:grid md:grid-cols-12 gap-8 md:gap-16">
                <div className="path-list flex flex-col gap-10 col-span-3">
                  <div className="path-item">
                    ...
                    <p className="paragraph-primary paragraph-color ">
                      Ravagers emerge with the ability to break through defenses
                      and remember player action.
                    </p>
                  </div>
                  <div className="path-item">
                    <span className="uppercase paragraph-orange-500 paragraph-medium pb-2">
                    ...
                    <p className="paragraph-primary paragraph-color ">
                      Player base defenses and advanced traps for dealing with
                      Ravagers.
                    </p>
                  </div>
                  <div className="path-item">
                    ...
                    <p className="paragraph-primary paragraph-color ">
                      Tactical memory-based AI for Ravagers, allowing them to
                      set ambushes.
                    </p>
                  </div>
                  <div className="path-item">
                    ...
                    <p className="paragraph-primary paragraph-color ">
                      Advanced resource gathering and more complex traps for
                      players.
                    </p>
                  </div>
                </div>
              ...
              <div className="path-section flex flex-col-reverse md:grid md:grid-cols-12 gap-8 md:gap-16">
                <div className="path-list flex flex-col gap-10 col-span-3">
                  <div className="path-item">
                    ...
                    <p className="paragraph-primary paragraph-color ">
                      ntroduction of Alphas as horde leaders, boosting other
                      zombies’ abilities.
                    </p>
                  </div>
                  <div className="path-item">
                    ...
                    <p className="paragraph-primary paragraph-color ">
                      Juggernauts emerge, leading massive hordes and breaking
                      through defenses.
                    </p>
                  </div>
                  <div className="path-item">
                    ...
                    <p className="paragraph-primary paragraph-color ">
                      Reanimation system, where fallen zombies return with
                      enhanced abilities.
                    </p>
                  </div>
                  <div className="path-item">
                    ...
                    <p className="paragraph-primary paragraph-color ">
                      Leadership boosts for reanimated zombies when near Alphas
                      or Juggernauts.
                    </p>
                  </div>
                </div>
              ...
              <div className="path-section flex flex-col-reverse  md:flex-col gap-8 md:gap-16">
                <div className="path-list flex flex-col gap-10 md:grid md:grid-cols-3">
                  <div className="path-item">
                    ...
                    <h3 className="title-h4 title-color pb-4">
                      Evolved Beyond Death
                    </h3>
                    <span className="paragraph-medium title-color block">
                      Release Date: May 23, 2025
                    </span>
                    <p className="paragraph-primary paragraph-color ">
                      Final evolution forms for zombies, with max-level Alphas
                      and Juggernauts.
                    </p>
                  </div>
                  <div className="path-item">
                    ...
                    <p className="paragraph-primary paragraph-color ">
                      Nuke activation system and extraction mechanics for
                      players to escape.
                    </p>
                  </div>
                  <div className="path-item">
                    ...
                    <p className="paragraph-primary paragraph-color ">
                      Endgame balancing, where players face the toughest evolved
                      zombies.
                    </p>
                  </div>
                </div>
        ...
        <footer className="main footer-image ">
          <div className="main py-40">
            <section className="main-inner-section">
              ...
              <div>
                <p className="paragraph-color text-center pt-32 pb-4">
                  © 2024 Half Byte Games LLC. All Rights Reserved.
                </p>
                <div className="flex gap-8 justify-center paragraph-yellow-500">
                  <a
                    target="_black"
                    href="https://x.com/DawnOfficialHQ"
                    className="transition ease-in-out delay-150 hover:scale-110 hover:color-[#F6FF89] duration-300"
                  >
                    X
                  </a>
                  <a
                    target="_black"
                    href="https://discord.com/invite/F6f7J357uX"
                    className="transition ease-in-out delay-150 hover:scale-110 hover:color-[#F6FF89] duration-300"
                  >
                    Discord
                  </a>
                  <a
                    target="_black"
                    href="https://www.youtube.com/@halfbytegamesllc5419"
                    className="transition ease-in-out delay-150 hover:scale-110 hover:color-[#F6FF89] duration-300"
                  >
                    YouTube
                  </a>
